...
.equ b9, 0b100000000
.equ b10, 0b100000000
.equ b11, 0b1000000000
.equ b12, 0b10000000000
.equ b13, 0b100000000000
.equ b14, 0b1000000000000
.equ b15, 0b10000000000000
...
swi 0x204
@ldr r5,=i       @indice para as operaçoes que o solicitarem
@ldr r5,[r5]
...
mov r5,r4       @ Salva o valor do fatorial que o usuario deseja
fatorial1:
    sub r3,r3,#1
    mul r4,r3,r4
    cmp r3,#1
...
mov r1,#5
mov r2,r4      
swi 0x205       @Imprime o valor 1 no display
mov r0,#6       @ Seta a posicao do display onde a mensagem vai ser lida
mov r1,#5
ldr r2,=simbolo_sub
swi 0x204
...
mov r1,#5
mov r2,r8      
swi 0x205       @Imprime o valor 1 no dispaly
mov r0,#7       @ Seta a posicao do display onde a mensagem vai ser lida
mov r1,#5
ldr r2,=simbolo_igual
swi 0x204
